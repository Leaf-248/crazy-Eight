...
public abstract class Player {
   ...
   public boolean hasPlayableCard(Card top) {
      ...
      //search through player's hand; 
      for (int i = 0; i < this.hand.size(); i++) {
         if (this.hand.getCard(i).getRank() == top.getRank()) {
            return true;
         } else if (this.hand.getCard(i).getSuit() == top.getSuit()) {
            return true;
         } else if (this.hand.getCard(i).getRank() == 8 || top.getRank() == 8) {
            return true;
         }
